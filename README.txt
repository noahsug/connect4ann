...
==============================================================================
    ...
    The makefile commands for playing are:

        make playHumanvs8ply
        make playHumanvsHeuristic
        make playRandomvs8ply
        make playRandomvsHeuristic
        make playCompvsComp
...
==============================================================================
  ...
  --Source code:
    The source code is located in this main directory, as
    well as datasets/training, and data_generation. 
    The .m files are the matlab source files and .py files
  ...
  --Report document:
    The report document is in:
    ConnectFourReport.pdf and ConnectFourReport.docx
